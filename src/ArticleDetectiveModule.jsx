 ...
 * Advanced scientific article analysis tool
 */
const ArticleDetective = () => {
  ...
  return (
    <div className="article-detective" style={styles.container}>
      <textarea
      ...
      <div style={styles.buttonGroup}>
        <button onClick={performAnalysis} style={styles.analyzeBtn}>Analyze Article</button>
      </div>

      {/* Results Rendering */}
      {results.detectedGenes.length > 0 && (
        <div style={styles.resultsArea}>
          <h3 style={styles.subHeader}>Detected Genes:</h3>
